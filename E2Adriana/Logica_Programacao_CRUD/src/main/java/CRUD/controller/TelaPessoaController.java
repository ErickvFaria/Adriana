...
public class TelaPessoaController {
    ...
    @FXML
    private void cadastrarPessoas(ActionEvent event) {
        abrirTela("/fxml/TelaCadastrarPessoa.fxml", "Cadastrar Pessoa");
    }

    @FXML
    private void listarPessoas(ActionEvent event) {
        try {
            ...
            CRUD.controller.TelaListaController<Pessoa> controller = loader.getController();
            controller.configurar(new PessoaDAO(), Pessoa.class);
